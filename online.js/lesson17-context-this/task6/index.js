...
обновлена: 12 декабря 2020 08:31
Функция с закрепленным контекстом
С помощью метода .bind можно создать НОВУЮ ф-цию с заданным контекстом. А так же дополнительно можно закрепить в новой ф-ции несколько аргументов (func.bind(context, arg1, arg2, ...))

Основные требования:
Начальный код находится в редакторе
Используй метод .bind для создания ф-ций в каждом задании
Код для проверки должен находится в файле index.js
Все созданные ф-ции экспортируй из файла под своими именами
*/
